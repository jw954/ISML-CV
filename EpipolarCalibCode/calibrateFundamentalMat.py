...
ret, H1, H2 = cv2.stereoRectifyUncalibrated(primal_coordinates, dual_coordinates, F, [H,W])
...
sio.savemat("fundamentalmatrix.mat",{"F" : F}, {"dual_coordinates" : dual_coordinates}, {"primal_coordinates": primal_coordinates}, {"H1":H1}, {"H2":H2})
